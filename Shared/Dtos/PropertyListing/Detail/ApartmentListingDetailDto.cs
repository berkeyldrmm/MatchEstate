...
{
    public class ApartmentListingDetailDto : PropertyListingDetailDto, IPropertyListingDetailDto
    {
        ...
        public string NumberOfBalcony { get; set; }
        public string NumberOfBathrooms { get; set; }
        public bool IsResidentalComplex { get; set; }
